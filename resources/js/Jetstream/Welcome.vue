        ...
        <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2" v-if="$page.props.user.uscmpc_id != null && $page.props.user.can_vote">
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 text-2xl text-gray-600 leading-7 font-bold"><a v-bind:href="route('election')">Election</a></div>
                </div>
                ...
                <div class="ml-12">
                    <div class="mt-2 text-lg text-gray-500">
                        ...
                        <div class="list-disc pl-2">
                            ...
                            <li>registered during the General Assembly Day.</li>
                    ...
                    <div class="mt-2 text-lg text-gray-500">
                        ...
                        <div class="list-none pl-7 font-bold">
                            <li class="italic">As stated in the email.</li>
                        </div>

                    </div>

                    <a v-bind:href="route('election')">
                        <div class="mt-3 flex items-center text-2xl font-semibold text-indigo-700">
            ...
            <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
                <div class="flex items-center">
                    ...
                    <div class="ml-4 text-2xl text-gray-600 leading-7 font-semibold"><a v-bind:href="route('poll')">Poll</a></div>
                </div>
